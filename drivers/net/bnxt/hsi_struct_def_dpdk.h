...
#define HWRM_VERSION_STR "1.9.2.26"
...
struct hwrm_cfa_redirect_query_tunnel_type_output {
	...
	#define CFA_REDIRECT_QUERY_TUNNEL_TYPE_RESP_TUNNEL_MASK_L2_ETYPE      0x800UL
	#define CFA_REDIRECT_QUERY_TUNNEL_TYPE_RESP_TUNNEL_MASK_ANYTUNNEL     0x1000UL
	uint8_t	unused_0[3];
	uint8_t	valid;
};
